...
if __name__ == '__main__':
    # ==================== CONFIGURATION ====================
<<<<<<< HEAD:Massgraves/finalMG/axialselect/chooseLabelAxials.py
    PATIENT = 'Gerda'  # Change this to: 'Maria', 'Jarek', 'Jan', 'Gerda', 'Loes', 'Joop'
=======
    PATIENT = 'Joop'  # Change this to: 'Maria', 'Jarek', 'Jan', 'Gerda', 'Loes', 'Joop'
>>>>>>> 2f83834b68683f659d0433b29e2498ff3abedf39:Massgraves/finalMG/preprocessor/chooseLabelAxials.py
    # =======================================================
