...
def main():
    ...
    source_folder = os.path.join(massgraves_root, 'nifti-stitched')
    ...
    for name in body_order:
        filepath = os.path.join(source_folder, f'{name}{file_suffix}')
    ...
    if not available_bodies:
        print()
        print(f"❌ No stitched bodies found in {source_folder}/")
        print("   Run bodystitcher.py first!")
        return
